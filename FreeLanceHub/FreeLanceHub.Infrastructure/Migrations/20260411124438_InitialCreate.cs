        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Gigs_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    SelectedStudentId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_SelectedStudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GigSkills", x => new { x.GigId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_GigSkills_Gigs_GigId",
                        column: x => x.GigId,
                        principalTable: "Gigs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GigSkills_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderSkills", x => new { x.OrderId, x.SkillId });
                    table.ForeignKey(
                        name: "FK_OrderSkills_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderSkills_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gigs_StudentId",
                table: "Gigs",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_GigSkills_SkillId",
                table: "GigSkills",
                column: "SkillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_SelectedStudentId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderSkills_SkillId",
                table: "OrderSkills",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_Proposals_OrderId_StudentId",
                table: "Proposals",
